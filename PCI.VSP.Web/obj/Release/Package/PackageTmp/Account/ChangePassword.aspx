<%@ Page Title="Change Password" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="ChangePassword.aspx.cs" Inherits="PCI.VSP.Web.Account.ChangePassword" %>
                ...
                <asp:ChangePassword ID="ChangeUserPassword" runat="server" CancelDestinationPageUrl="~/"
                    ...
                    <ChangePasswordTemplate>
                        ...
                        <asp:ValidationSummary ID="ChangeUserPasswordValidationSummary" runat="server" CssClass="failureNotification"
                            ValidationGroup="ChangeUserPasswordValidationGroup" ForeColor="Black" />
                            ...
                            <fieldset class="changePassword">
                                ...
                                <p>
                                    ...
                                    <asp:CompareValidator ID="NewPasswordCompare" runat="server" ControlToCompare="NewPassword"
                                        ...
                                        ErrorMessage="The Confirm New Password must match the New Password entry." ValidationGroup="ChangeUserPasswordValidationGroup">* Password confirmation mismatch</asp:CompareValidator>
                                </p>
                            </fieldset>
