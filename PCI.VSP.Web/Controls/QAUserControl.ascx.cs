                        ...
                        case DataTypes.Text:
                            ...
                            switch ((AnswerTypes)aq.AnswerType)
                            {
                                case AnswerTypes.SingleValue:
                                    ...
                                    textBox.ID = "tb" + ((DataTypes)aq.QuestionDataType).ToString();
                                    textBox.Text = aq.Answer;
                                    textBox.CssClass = ((DataTypes)aq.QuestionDataType).ToString();
                                    ...
                                    if ((DataTypes)aq.QuestionDataType == DataTypes.Integer)
                                    {
                                        ...
                                        rangeValidator.MinimumValue = intMin.ToString();
                                        rangeValidator.MaximumValue = intMax.ToString();
                                        rangeValidator.ControlToValidate = textBox.ID;
                                        rangeValidator.ValidationGroup = validationGroup;
                                        rangeValidator.ErrorMessage = string.Format(singleValueOutOfRangeMessage, (e.Item.ItemIndex + 1), intMin.ToString(), intMax.ToString());
