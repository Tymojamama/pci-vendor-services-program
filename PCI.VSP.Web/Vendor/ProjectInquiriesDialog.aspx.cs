...
namespace PCI.VSP.Web.Vendor
{
    public partial class ProjectInquiriesDialog : System.Web.UI.Page
    {
        ...
        private void InitialLoad()
        {
            ...
            ServiceModel.QuestionCategorizationItem mainCategory = null;
            ServiceModel.QuestionCategorizationItem subCategory = null;
            int index = 0;

            foreach (ServiceModel.QuestionCategorizationItem item in qcf)
            {
        ...
        protected void ddlCategories_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (list != null)
                {
                    var qci = new System.Web.Script.Serialization.JavaScriptSerializer().Deserialize<ServiceModel.QuestionCategorizationItem>(list.SelectedItem.Value);
                    hfType.Value = ((int)qci.Type).ToString();
