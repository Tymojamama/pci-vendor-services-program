    ...
    <div class="small-width">
        <div class="contentheader">
            ...
            <div class="contentheadersubtext">
                edit user permissions and create new users
            </div>
        </div>
        <div>
            <asp:Panel runat="server">
                <div class="contentgridviewcontainer">
                    <asp:GridView ID="ContactsGridView" runat="server" EnableViewState="False" AutoGenerateColumns="False"
                        OnRowDataBound="ContactsGridView_RowDataBound" Width="100%" CellPadding="4" HeaderStyle-CssClass="table-header" 
                ...
                <br />
                <input id="CreateUserButton" type="button" runat="server" value="New User" class="button" onclick="refreshVendorProducts('');" />
            </asp:Panel>
