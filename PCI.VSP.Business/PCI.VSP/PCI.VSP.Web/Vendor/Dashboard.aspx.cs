...
namespace PCI.VSP.Web.Vendor
{
    public partial class Dashboard : System.Web.UI.Page
    {
        ...
        private void RefreshVendorProducts()
        {
            ...
            List<Data.Classes.VendorProductSummary> vpsl = new VendorQuestionDataLogic(GetDefaultAuthRequest()).GetVendorProductDashboard(user.AccountId, user.Id);
            Session[Constants.VendorProductDashboard] = vpsl;
        }

        private void BindVendorProducts()
        {
            List<Data.Classes.VendorProductSummary> vpsl = (List<Data.Classes.VendorProductSummary>)Session[Constants.VendorProductDashboard];
            VendorProductGridView.DataSource = vpsl;
