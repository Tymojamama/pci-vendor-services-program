...
namespace PCI.VSP.Data.CRM.Model
{
    ...
    public class VendorQuestion : EntityBase
    {
        ...
        public VendorQuestion(DynamicEntity e) : base(e) { }
        public VendorQuestion(EntityBase e) :
            base(e.Name)
        {
            this.Properties = e.Properties;
            this.Attributes = e.Attributes;
        }
        public VendorQuestion(Question q) : base("vsp_vendorquestion")
        {
            Name = q.Name;
            ...
            PlanAssumptionId = q.PlanAssumptionId;
            QuestionType = q.QuestionType;
            FeeType = q.FeeType;
            AssetClassId = q.AssetClassId;
            AssetFund = q.AssetFund;
            AssetSymbol = q.AssetSymbol;
            Participants = q.Participants;
            Assets = q.Assets;
            AnnualContributions = q.AnnualContributions;
            PCICommentToVendor = q.PCICommentToVendor;
            DocumentTemplateId = q.DocumentTemplateId;
        }
        public VendorQuestion(XElement el)
            : base ("vsp_vendorquestion", el)
        {
        }
        ...
        {
            get { return base.GetPropertyValue<Guid>(DataConstants.vsp_serviceproviderid, PropertyType.Lookup, Guid.Empty); }
            set { base.SetPropertyValue<Guid>(DataConstants.vsp_serviceproviderid, PropertyType.Lookup, value); }
        }

        #region Question/Answer Properties
        ...
        {
            get { return base.GetPropertyValue<Int32>("vsp_sortorder", PropertyType.Number, 1); }
        ...
        #region Investment Assumption Properties
        ...
        #region Revenue Sharing Properties
        ...
        public Decimal AssetBasedAdministrativeFee
        {
            get { return base.GetPropertyValue<Decimal>("vsp_assetbasedadministrativefee", PropertyType.Decimal, 0m); }
            set { base.SetPropertyValue<Decimal>("vsp_assetbasedadministrativefee", PropertyType.Decimal, value); }
        }

        public Decimal CurrentPerHeadSubta
        {
            get { return base.GetPropertyValue<Decimal>("vsp_currentperheadsubta", PropertyType.Decimal, 0); }
            set { base.SetPropertyValue<Decimal>("vsp_currentperheadsubta", PropertyType.Decimal, value); }
        }
        ...
        public VendorMonitoringAnswerTypes VendorMonitoringAnswerType
        {
            get { return base.GetPropertyValue<VendorMonitoringAnswerTypes>(DataConstants.vsp_vendormonitoringanswertype, PropertyType.Picklist, VendorMonitoringAnswerTypes.None); }
            set { base.SetPropertyValue<VendorMonitoringAnswerTypes>(DataConstants.vsp_vendormonitoringanswertype, PropertyType.Picklist, value); }
        }
    }
}
